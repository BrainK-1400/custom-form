<template>
  <div class="widget" :class="{
    ...
    <template v-if="layout === 'Horizontal'">
      <div :class="widget.label.length > 14 ? 'widget-left-c' : 'widget-left'
        " :style="{ flexBasis: '180px' }">
        {{ widget.label }}
        <span class="widget-required margin-right-smini" v-if="isRequired">
          *
        </span>
        <a-tooltip v-if="widget.description && widget.isEditable" :title="widget.description">
